...
\begin{document}
	...
	\subsection*{Knotenlokale Verbesserungen}
		...
		Nach Anwendung eines solchen Schnitts wird das Modulo-Simplex-Verfahren erneut angewendet, um die gefundene modifizierte Lösung weiter zu optimieren. Dadurch
	% end
\end{document}
