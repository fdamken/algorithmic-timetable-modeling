...
\begin{document}
	...
	\subsection*{Knotenlokale Verbesserungen}
		...
		Ein einzelner Knoten \(i\) induziert nun einen Schnitt \( \vec{\eta}^{(i)} \) mit \( P = \{\, i \,\} \), \dh jede Kante um den Knoten wird geschnitten. Die Addition von \( \delta \) auf das Potential von \(i\) (\( \pi \))
	% end
\end{document}
