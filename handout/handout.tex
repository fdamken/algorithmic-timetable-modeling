...
\begin{document}
	...
	\section*{Definitionen}
		...
		Die Ereignisse und Einschränkungen \( \mathcal{A} \) formen einen Graphen, das sogenannte \emph{Ereignisnetzwerk}. Ein solcher Graph ist beispielhaft in Abbildung~\ref{fig:activity_network} gegeben.
		\begin{figure}[H]
			\centering
