...
\begin{document}
	...
	\subsection*{Knotenlokale Verbesserungen}
		...
		Nach Anwendung eines solchen Schnitts wird das Modulo-Simplex-Verfahren erneut angewendet, um die gefundene modifizierte Lösung weiter zu optimieren. Dadurch ist es möglich, ein besseres Optimum zu finden also nur durch Anwendung des Modulo-Simplex-Verfahrens.
	% end
\end{document}
