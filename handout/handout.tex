...
\begin{document}
	...
	\subsection*{Das Modulo-Netzwerk-Simplex-Verfahren}
		...
		\end{equation*}
		das heißt die Änderung \( \Delta\omega_{ij} \) ist gegeben durch
		\begin{equation*}
			\Delta\omega_{ij} = \tilde{\omega}_{ij} - \omega = \omega_j \bigg[ \frac{b_i}{\gamma_{ij}} \bigg]_T \! - \omega_i b_i + \sum_{\substack{k = r \\ k \neq i}}^{m} \omega_k \Bigg( \bigg[ b_k - \frac{\gamma_{kj}}{\gamma_{ij}} b_i \bigg]_T - b_k \Bigg)
		\end{equation*}
	% end
\end{document}
