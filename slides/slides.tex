...
%			\end{frame}
		...
		\subsection{Lokalität des Modulo-Netzwerk-Simplex-Verfahrens}
			\begin{frame}{Lokalität}
				\begin{itemize}
					...
					\item \emph{Achtung:} Die folgenden Verfahren verbessern zwar das lokale Minimum, garantieren aber keine globale Konvergenz!
				\end{itemize}
			\end{frame}
		% end
	% end
