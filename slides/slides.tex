...
%			}
	...
	\section{Modulo-Netzwerk-Simplex-Berechnungen}
		\todo{Modulo-Netzwerk-Simplex-Berechnungen}
		
		% TODO: Achtung, die Omegas entsprechen den Gewichten der Kanten, d.h. sie ändern sich bei einem Basisaustausch!
	
		\subsection{Modulo-Netzwerk-Simplex}
			\begin{frame}{Umformen der Netzwerkmatrix}
				content... % TODO
			\end{frame}
		
			% TODO: Folgenden Abschnitt vollständig auf den Modulo-Netzwerk-Simplex-Algorithmus ändern!
			\begin{frame}{Einleitung}
				Lösung des ganzzahligen lineares Optimierungsproblems
				\begin{align*}
	...
	\vdots &                \vdots                 & \ddots &         \vdots         & \ddots & \vdots & \ddots &     & \ddots & \vdots &             \vdots              &  \vdots  \\
	 x_j   &         \frac{a_{i1}}{a_{ij}}         & \cdots &    \frac{1}{a_{ij}}    & \cdots &   0    &        &  1  &        &   0    &       \left[\frac{b_i}{a_{ij}}\right]_T        & \omega_j \\
	\vdots &                \vdots                 & \ddots &         \vdots         & \ddots & \vdots & \ddots &     & \ddots & \vdots &             \vdots              &  \vdots  \\
