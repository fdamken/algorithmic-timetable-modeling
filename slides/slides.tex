				...
				\begin{minipage}{0.5\textwidth}
					\begin{figure}
						...
						\begin{tikzpicture}[event/.style = { draw, circle }, anchor = center]
							\node [event] (A) at (-2.3, -2.5) {\rom{1}};
							\node [event] (B) at (0, 0) {\rom{2}};
							\node [event] (C) at (-2.3, 2.5) {\rom{3}};
							\node [event] (D) at (2.5, 0) {\rom{4}};
			...
			\begin{frame}{Beispiel, Bestimmung der Basislösung}
				...
				\begin{minipage}{0.5\textwidth}
					\begin{figure}
						\centering
						\begin{tikzpicture}[event/.style = { draw, circle }, spanning/.style = { draw = tud9b }, co/.style = { draw = tud2b }, anchor = center]
							\node [event, label = below:{ \( \onslide<5->{\pi_A = 4} \) }] (A) at (-2.3, -2.5) {\rom{1}};
							\node [event, label =  left:{ \( \onslide<2->{\pi_B = 0} \) }] (B) at (0, 0) {\rom{2}};
							\node [event, label = right:{ \( \onslide<3->{\pi_C = 7} \) }] (C) at (-2.3, 2.5) {\rom{3}};
							\node [event, label = below:{ \( \onslide<4->{\pi_D = 2} \) }] (D) at (2.5, 0) {\rom{4}};
			...
			\begin{frame}{Beispiel, Spannbaum vor und nach Austausch}
				...
				\begin{minipage}{0.5\textwidth}
					\begin{figure}
						\centering
						\begin{tikzpicture}[event/.style = { draw, circle }, spanning/.style = { draw = tud9b }, co/.style = { draw = tud2b }, anchor = center]
							\node [event, label = below:{ \( \pi_A = 4 \) }] (A) at (-2.3, -2.5) {\rom{1}};
							\node [event, label =  left:{ \( \pi_B = 0 \) }] (B) at (0, 0) {\rom{2}};
							\node [event, label = right:{ \( \pi_C = 7 \) }] (C) at (-2.3, 2.5) {\rom{3}};
							\node [event, label = below:{ \( \pi_D = 2 \) }] (D) at (2.5, 0) {\rom{4}};
				...
				\begin{minipage}{0.5\textwidth}
					\begin{figure}
						...
						\begin{tikzpicture}[event/.style = { draw, circle }, spanning/.style = { draw = tud9b }, co/.style = { draw = tud2b }, anchor = center]
							...
							\node [event, label = below:{ \( \pi_D = 7 \) }] (D) at (2.5, 0) {\rom{4}};
